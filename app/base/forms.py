...
class EditProfileForm(FlaskForm):
    ...
    def_drom_area = SelectField('Зона Drom', id='drom_area', validate_choice=False, coerce=int)
...
class TirePrepareForm(FlaskForm):
    ...
    drom_display_area = SelectField('Зона показа Drom', validate_choice=False, coerce=int)
